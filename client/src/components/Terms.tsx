            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="space-y-6 mb-12">
                    {termsItems.map((item, index) => (
                        <div
                            key={index}
                            className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:border-blue-500/50 dark:hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg group"
                        >
